...
void RH_RF95::setSlaveSelectPin(uint8_t slaveSelectPin)
{
    _slaveSelectPin = slaveSelectPin;
}

// Blocks until a valid message is received
void RH_RF95::waitAvailable()
{
    while (!available())
    YIELD;
}
...
bool RH_RF95::waitAvailableTimeout(uint16_t timeout)
{
